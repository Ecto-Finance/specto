...
export const LENS_PROXY_ADDRESS = process.env.NEXT_PUBLIC_LENS_PROXY_ADDRESS;
export const SPECTO_SWAP_ADDRESS = process.env.NEXT_PUBLIC_SPECTO_SWAP_ADDRESS;
