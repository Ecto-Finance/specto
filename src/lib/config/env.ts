...
export const LENS_PROXY_ADDRESS = process.env.NEXT_PLUBIC_LENS_PROXY_ADDRESS;
export const SPECTO_SWAP_ADDRESS = process.env.NEXT_PLUBIC_SPECTO_SWAP_ADDRESS;
